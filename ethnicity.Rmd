...
* [phdnames.rda](https://github.com/ammulders/amatteroftime/data/processed/phdnames.rda): example dataset of 8 (fictional) PhDs with first and last names
    - For construction of this dataset see [Independent variables: names](names.html)  
    - name of dataset: `phdnames` 

* [lastname_origin.rda](https://github.com/ammulders/amatteroftime/data/processed/lastname_origin.rda): web scraped ethnicity data for the 8 last names in the example data from de Nederlandse Familienamenbank
