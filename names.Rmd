...
```{r, results='hide'}
packages = c("tidyverse", "stringr", "stringi", "formatR")
...
# 1: Gathering first names from 'auteur'(Author) on NARCIS dissertation pages
...
# 2: Last names from 'auteur' on NARCIS dissertation page
...
# 3: Extracting first names from personal NARCIS profiles
...
# 4: Combining first name information from dissertation & personal NARCIS pages
...
# 5: First names from dissertation PDFs
...
# 6: Gathering last names from the dissertation PDFs
...
# 7: Harmonizing names from NARCIS pages and dissertation text
...
phd_metadf[,c(8,1,2,3,4,9,11,10,12,5,6,7)]
